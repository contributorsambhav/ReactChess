...
function Home() {
  ...
  return (
    ...
    >
      <div className="font-serif tracking-wide bg-gray-800 flex flex-col bg-opacity-30 backdrop-filter backdrop-blur-xl border border-gray-500 p-8 rounded-xl shadow-lg text-center w-11/12 lg:w-2/3 lg:w-1/2 xl:w-1/2 h-2/3 lg:h-1/2">
