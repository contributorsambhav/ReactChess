    ...
    >
      <div className="w-screen flex flex-col md:flex-row mx-auto my-auto">
        ...
        <div className="ml-4 w-full md:w-1/3 mt-4 md:mt-0">
          <div className="rounded-xl shadow-lg text-center p-8 px-16 w-full text-4xl bg-gray-400 bg-opacity-30 text-white border border-gray-200 flex-shrink-0">
          ...
          <div className="mt-4">
            ...
            <select
              ...
              className="bg-gray-400 bg-opacity-30 text-white px-4 py-2 rounded-lg w-full text-lg"
            >
              <option
          ...
          <div className="mx-2 mt-3 text-center border border-gray-800 text-2xl text-white bg-black bg-opacity-20 p-4 rounded-lg">
            If the game goes to start after promotion piece change, just attempt
            an illegal move, it will get OK so relax
          </div>
          <button
            onClick={toggleTable}
            className="mt-4 bg-gray-400 bg-opacity-30 text-white border border-gray-200 px-6 py-3 rounded-lg w-full text-xl"
          >
              ...
              <table className="w-full border-collapse border border-gray-700 rounded-lg bg-gray-400 bg-opacity-30 text-white">
                <thead>
                  <tr className="bg-gray-800 bg-opacity-30 text-center text-white">
                    <th className="border border-gray-400 px-6 py-3 text-xl">
                      Move
                    </th>
                    <th className="border border-gray-400 px-6 py-3 text-xl">
                      From
                ...
                <tbody>
                  {moves.map((move, index) => (
                    ...
                    >
                      <td className="border border-gray-400 px-6 py-4 text-xl">
                        {index + 1}
                      </td>
                      <td className="border border-gray-400 px-6 py-4 text-xl">
                        {move.from}
