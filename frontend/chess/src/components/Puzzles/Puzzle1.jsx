...
const Puzzle1 = () => {
  ...
  return (
    <div className='w-full flex flex-col items-center h-screen'>
      <h1 className='text-3xl font-bold mt-4'>The Magician's Puzzle</h1>
      <div className='w-[80%] p-4 text-lg'>
        <p>
          "Grandmasters and Engines Couldn't Solve This Puzzle. Then Came The Magician".
          This puzzle was composed by Gijs van Breukelen. It was created in somewhat around 1970 but published in the 1990s.
