...
const Puzzle3 = () => {
  ...
  return (
    ...
    >
      <h1 className='text-3xl font-bold mt-16 lg:mt-4 z-10'>The Enigmatic Puzzle</h1>
      <div className='w-[80%] p-4 text-lg'>
        <p>
          This puzzle was composed by Unknown. It is known for its complexity and strategic depth.
