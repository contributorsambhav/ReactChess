    ...
    return (
        ...
        >
            <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-xl border border-gray-200 p-8 md:p-12 lg:p-16 rounded-xl shadow-lg w-11/12 max-w-md lg:max-w-lg xl:max-w-xl">
                ...
                <h2 className="md:text-4xl lg:text-5xl sm:text-3xl font-semibold text-center text-white mb-12">Sign Up</h2>
                <form className="space-y-6">
                    ...
                    <div className="text-center tracking-wider  text-lg underline text-white">
                        Already have an account? <Link to="/login" className="text-purple-300 hover:text-white">Login</Link>
                    </div>
                </form>
            </div>
        </div>
